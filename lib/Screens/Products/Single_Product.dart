...
class SingleProductScreen extends StatefulWidget {
  ...
  SingleProductScreen({Key? key, required this.productIndex}) : super(key: key);
...
class _SingleProductScreenState extends State<SingleProductScreen> {
  ...
  Future<void> addToCart(String userId, int productId) async {
    final url = Uri.parse('https://graduation-project-nodejs.onrender.com/api/cart/add-item');
  ...
  Future<void> addToFavorites(String userId, int productId) async {
    final url = Uri.parse('https://graduation-project-nodejs.onrender.com/api/products/fav/add');
  ...
  Future<void> removeFromFavorites(String userId, int productId) async {
    final url = Uri.parse('https://graduation-project-nodejs.onrender.com/api/products/fav/remove');
    final response = await http.post(
      url,
      headers: <String, String>{
        'Content-Type': 'application/json',
