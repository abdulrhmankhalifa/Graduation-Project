...
class _CartScreenState extends State<CartScreen> {
                      ...
                      child: const Row(
                        ...
                        children: [
                          Text(
                            'Check Out',
                            style:
                                TextStyle(color: defaultColor, fontSize: 20.0),
                          ),
                          Icon(
                            Icons.arrow_forward,
                            color: defaultColor,
  ...
  Future<void> GetData() async {
    ...
    final url =
        'https://graduation-project-nodejs.onrender.com/api/cart/$userId';
  ...
  Future<void> deleteCartItem() async {
    ...
    try {
      final response = await http.delete(
        Uri.parse(
            'https://graduation-project-nodejs.onrender.com/api/cart/clear/$userId'),
  ...
  Future<void> deleteItemFromCart(int itemId, String firebaseId) async {
    final url =
        'https://graduation-project-nodejs.onrender.com/api/cart/remove-item/$itemId'; // Replace with your actual API endpoint
